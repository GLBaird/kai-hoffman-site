...
<div id="construction" class="modal">
    <div class="modal-content">
        ...
        <p>For now, enjoy what has been done, and check back soon to see my exciting&nbsp;new&nbsp;content.</p>
...
//            $('#construction').openModal();
    ...
    $('a[href="#"]:not(.map-link)').click(function(e){ e.preventDefault(); $('#construction').openModal(); });
</script>
